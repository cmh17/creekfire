...
hist(data_table_cleaned[data_table_cleaned$within_burn_area == FALSE]$dnbr)
hist(data_table_cleaned[data_table_cleaned$within_burn_area == TRUE]$dnbr)

hist(data_table_cleaned[data_table_cleaned$within_burn_area == FALSE]$prefire_nbr)
hist(data_table_cleaned[data_table_cleaned$within_burn_area == TRUE]$prefire_nbr)

hist(data_table_cleaned$prefire_ndvi)
...
write.csv(data_table_cleaned, "Data/big_table.csv", row.names = FALSE)
