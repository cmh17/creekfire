...
fire <- load_fire_boundaries(str_to_upper(fire_name), boundary_folder)

# Create a buffer around the fire boundary
fire_buffer <- get_buffer(fire, fire_name, boundary_folder, buffer_dist, write=TRUE)
...
# Pier:
# Prefire 2017-06-01 to 2017-08-31
# Postfire 2018-06-01 to 2018-08-31
# date_ranges <- c('2017-06-01T00:00:00Z/2017-07-01T00:00:00Z',
#                  '2017-07-01T00:00:00Z/2017-08-01T00:00:00Z',
#                  '2017-08-01T00:00:00Z/2017-09-01T00:00:00Z',
...
# Donnel:
# Prefire 2018-05-01 to 2018-07-31
# Postfire 2019-05-01 to 2019-07-31
...
hls_small_date_ranges <- as.Date(unlist(lapply(et_date_ranges, function(x) {c(seq(from=x[1], to=x[2] %m+% months(1), by="10 days"), x[2] %m+% months(1))})))
hls_small_date_ranges <- c(paste0(head(hls_small_date_ranges, -1), "T00:00:00Z/", tail(hls_small_date_ranges, -1), "T00:00:00Z"))
...
# # Note: partial missing data for 6/11, so had to omit that date
# ugh <- c("2021-06-01T00:00:00Z/2021-06-10T00:00:00Z", "2021-06-12T00:00:00Z/2021-06-21T00:00:00Z", "2021-06-21T00:00:00Z/2021-07-01T00:00:00Z",
#          "2021-07-01T00:00:00Z/2021-07-11T00:00:00Z", "2021-07-11T00:00:00Z/2021-07-21T00:00:00Z", "2021-07-21T00:00:00Z/2021-07-31T00:00:00Z",
#          "2021-07-31T00:00:00Z/2021-08-01T00:00:00Z")

# call the function
save_hls_bands(fire_buffer_path, hls_date_ranges[3:7], et_ref_path, hls_path)
...
ggplot(subset_df, aes(x = lon, y = lat, color = aet)) +
    ...
    theme_minimal() +
    labs(title = "Spatial Distribution of Selected Points", color = "Absolute Change in\nEvapotranspiration")
