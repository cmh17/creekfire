...
bam_rET_interaction_reduced <- mgcv::bam(rET ~ s(dnbr) + s(lat) + s(precip) + 
...
bam_rET_interaction_reduced.summary

# check model diagnostics
gam.check(bam_rET_interaction_reduced) 

save(bam_rET_interaction_reduced, file=paste0(outDir,"/bam_rET_interaction_reduced.rds"))
```
