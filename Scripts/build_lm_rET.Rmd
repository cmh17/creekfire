...
save(lm_rET, file = paste0(outDir, "/lm_rET.rds"))
```
...
save(lm_rET_interaction, file = paste0(outDir,"/lm_rET_interaction.rds"))
...
save(lm_rET_interaction_reduced, file = paste0(outDir, "/lm_rET_interaction_reduced.rds"))
```
